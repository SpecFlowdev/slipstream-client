...
- **Профили серверов** — домен, резолвер, пиннинг сертификата, локальный порт и логин с паролем прокси, отдельно для каждого сервера. Сертификат можно вставить прямо текстом или выбрать файлом — закрепится в любом случае
- **Живая статистика** — графики приёма и отдачи за последнюю минуту, сглаженные, со свечением, итоги сессии, число открытых соединений и время работы
- **Просмотр логов** — вывод самого туннеля с фильтром по уровню и автопрокруткой
- **Работа в трее на Windows** — закрытие окна не рвёт туннель; подключение при запуске включается по желанию. На Linux закрытие окна завершает приложение: системный трей, на котором это держалось бы, на части Wayland-окружений надёжно роняет процесс, поэтому там он вообще не собирается
- **Тёмно-серая, синяя или светлая тема, русский и английский** — по системным или принудительно любая из трёх; в тёмно-серой теме можно поставить свои обои, видны сквозь матовые панели
...
<table>
  ...
  <tr>
    ...
    <td align="center"><strong>Настройки</strong> — kill switch, тема и обои</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="50%"><img src="assets/screenshot-connection.png" alt="Синяя тема"></td>
  </tr>
  <tr>
    <td align="center"><strong>Русский язык</strong> — переключается в настройках</td>
    <td align="center"><strong>Синяя тема</strong> — третий вариант</td>
  </tr>
</table>
