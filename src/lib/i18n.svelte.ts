...
const en = {
  ...
  "profiles.share": "Share",
  "profiles.shareTitle": "Share this server",
  "profiles.shareHint":
    "Scan this with the Android app's camera, or copy the link below. It carries the server's settings, not this device's local port or proxy credentials.",
  "profiles.shareCopy": "Copy link",
  "profiles.shareCopied": "Copied",
  "profiles.shareClose": "Close",
  "profiles.import": "Add from a link",
  "profiles.importTitle": "Add a server from a link",
  "profiles.importHint": "Paste a slipstream:// link, from the Android app's Share screen or another copy of this one.",
  "profiles.importPlaceholder": "slipstream://p?v=1&d=…",
  "profiles.importFromImage": "Read from an image…",
  "profiles.importSubmit": "Add",
  "profiles.importCancel": "Cancel",
  "profiles.importNoCode": "No QR code was found in that image.",
  "profiles.importSuccess": "Added",
  "profiles.importDone": "Done",
...
const ru: Record<Key, string> = {
  ...
  "profiles.share": "Поделиться",
  "profiles.shareTitle": "Поделиться сервером",
  "profiles.shareHint":
    "Отсканируйте камерой в приложении для Android или скопируйте ссылку ниже. В ней настройки сервера — без локального порта и логина/пароля прокси этого устройства.",
  "profiles.shareCopy": "Скопировать ссылку",
  "profiles.shareCopied": "Скопировано",
  "profiles.shareClose": "Закрыть",
  "profiles.import": "Добавить по ссылке",
  "profiles.importTitle": "Добавить сервер по ссылке",
  "profiles.importHint": "Вставьте ссылку slipstream://, полученную с экрана «Поделиться» в приложении для Android или из другой копии этого клиента.",
  "profiles.importPlaceholder": "slipstream://p?v=1&d=…",
  "profiles.importFromImage": "Считать с изображения…",
  "profiles.importSubmit": "Добавить",
  "profiles.importCancel": "Отмена",
  "profiles.importNoCode": "На этом изображении не нашёлся QR-код.",
  "profiles.importSuccess": "Добавлено",
  "profiles.importDone": "Готово",
